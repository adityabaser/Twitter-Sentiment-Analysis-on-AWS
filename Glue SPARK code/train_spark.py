...
## @type: DataSource
## @args: [database = "traindb", table_name = "train", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "traindb", table_name = "train", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://group16-assignment-6/data_preprocess/train"}, format = "json", transformation_ctx = "datasink2"]
## @return: datasink2
