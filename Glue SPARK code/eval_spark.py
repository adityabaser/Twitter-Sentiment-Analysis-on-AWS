...
## @type: DataSource
## @args: [database = "evaldb", table_name = "eval", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "evaldb", table_name = "eval", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://group16-assignment-6/data_preprocess/eval"}, format = "json", transformation_ctx = "datasink2"]
## @return: datasink2
...
datasink2 = glueContext.write_dynamic_frame.from_options(frame = map1, connection_type = "s3", connection_options = {"path": "s3://group16-assignment-6/data_preprocess/eval"}, format = "json", transformation_ctx = "datasink2")
job.commit()